        ...
        <div className="column">
          ...
          <article className="about-text">
            ...
            <div>
              ...
              <p>Motion graphics runs alongside all of that, and a good deal of the discipline came from it. For AT&amp;T I produced animated banners and social video at campaign volume, in GSAP and Adobe Animate for the interactive work and After Effects for the video, where the hard part is rarely any single execution and almost always consistency across every format a campaign needs. Producing at that rate surfaces the same mechanical bottlenecks over and over, so I built the automation that took the resizing and exporting over, which moved the time from the mechanics of shipping the work to the work itself. It is still part of what I do, and it still feeds the rest: Chromaforge renders its own promotional video in the browser rather than in After Effects.</p>
